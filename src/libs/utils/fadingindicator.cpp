...
FadingIndicatorPrivate::FadingIndicatorPrivate(QWidget *parent, FadingIndicator::TextSize size)
    : QWidget(parent)
{
...
void FadingIndicatorPrivate::setText(const QString &text)
{
    m_pixmap = QPixmap();
...
void FadingIndicatorPrivate::setPixmap(const QString &uri)
{
    m_label->hide();
...
void FadingIndicatorPrivate::run(int ms)
{
    show();
    raise();
...
void FadingIndicatorPrivate::paintEvent(QPaintEvent *)
{
    QPainter p(this);
...
void FadingIndicatorPrivate::runInternal()
{

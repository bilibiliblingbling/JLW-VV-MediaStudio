...
static Theme *m_mediastudioTheme = 0;
...
{
    return m_mediastudioTheme;
}

void setMediaStudioTheme(Theme *theme)
{
    if (m_mediastudioTheme == theme)
        return;
    delete m_mediastudioTheme;
    m_mediastudioTheme = theme;
}

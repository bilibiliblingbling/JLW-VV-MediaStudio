...
class MEDIASTUDIO_UTILS_EXPORT Theme : public QObject
{
    Q_OBJECT
...
MEDIASTUDIO_UTILS_EXPORT void setMediaStudioTheme(Theme *theme);
MEDIASTUDIO_UTILS_EXPORT Theme *mediastudioTheme();

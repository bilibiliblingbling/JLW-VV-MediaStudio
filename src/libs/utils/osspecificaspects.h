...
#ifndef OS_SPECIFIC_ASPECTS_H
#define OS_SPECIFIC_ASPECTS_H

#include <QString>

#include "utils_global.h"

#define KVMS_WIN_EXE_SUFFIX ".exe"
...
class MEDIASTUDIO_UTILS_EXPORT OsSpecificAspects
{
public:
    ...
    QString withExecutableSuffix(const QString &executable) const {
        ...
        if (m_osType == OsTypeWindows)
            finalName += QLatin1String(KVMS_WIN_EXE_SUFFIX);
        return finalName;
    }

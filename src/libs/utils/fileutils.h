...
MEDIASTUDIO_UTILS_EXPORT QDebug operator<<(QDebug dbg, const Utils::FileName &c);

QT_END_NAMESPACE

namespace Utils {

class MEDIASTUDIO_UTILS_EXPORT FileName : private QString
{
public:
    FileName();
...
MEDIASTUDIO_UTILS_EXPORT QTextStream &operator<<(QTextStream &s, const FileName &fn);

class MEDIASTUDIO_UTILS_EXPORT FileNameList : public QList<FileName>
{
public:
    inline FileNameList() { }
...
class MEDIASTUDIO_UTILS_EXPORT FileUtils {
public:
...
class MEDIASTUDIO_UTILS_EXPORT FileReader
{
...
class MEDIASTUDIO_UTILS_EXPORT FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
    FileSaverBase();
...
class MEDIASTUDIO_UTILS_EXPORT FileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
class MEDIASTUDIO_UTILS_EXPORT TempFileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
class MEDIASTUDIO_UTILS_EXPORT FileDropSupport : public QObject
{
    Q_OBJECT
public:
    struct FileSpec {
...
class MEDIASTUDIO_UTILS_EXPORT FileDropMimeData : public QMimeData
{
    Q_OBJECT
public:
    FileDropMimeData();
...
QT_BEGIN_NAMESPACE
MEDIASTUDIO_UTILS_EXPORT uint qHash(const Utils::FileName &a);
QT_END_NAMESPACE

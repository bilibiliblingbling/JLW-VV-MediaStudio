...
#ifndef HOST_OS_INFO_H
#define HOST_OS_INFO_H
...
#ifdef Q_OS_WIN
#define KVMS_HOST_EXE_SUFFIX KVMS_WIN_EXE_SUFFIX
#else
#define KVMS_HOST_EXE_SUFFIX ""
#endif // Q_OS_WIN

namespace Utils {

class MEDIASTUDIO_UTILS_EXPORT HostOsInfo
{
public:

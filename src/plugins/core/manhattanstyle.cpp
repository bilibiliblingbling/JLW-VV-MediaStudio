...
{
    QColor color = mediastudioTheme()->color(lightColored ? Theme::PanelTextColorDark
                                   ...
                                   QPainter *painter, const QWidget *widget) const
{
    ...
    case PE_IndicatorDockWidgetResizeHandle:
        painter->fillRect(option->rect, mediastudioTheme()->color(Theme::DockWidgetResizeHandleColor));
        break;
            ...
            if (!animating && anim) {
                ...
                if (pressed) {
                   ...
                   // painter->drawLine(rect.bottomLeft()  + QPoint(1, 0), rect.bottomRight()  - QPoint(1, 0));
                    ...
                    painter->fillRect(rect, mediastudioTheme()->color(Theme::PanelButtonToolBackgroundColorHover));
    ...
    case PE_PanelStatusBar:
        {
            if (mediastudioTheme()->widgetStyle() == Theme::StyleDefault) {
                painter->save();
                ...
                painter->fillRect(rect, mediastudioTheme()->color(Theme::PanelStatusBarBackgroundColor));
            }
        }
        break;
                                 ...
                                 QPainter *painter, const QWidget *widget) const
{
    ...
    switch (element) {
    case CE_Splitter:
        if (mediastudioTheme()->widgetStyle() == Theme::StyleFlat)
            painter->fillRect(option->rect, mediastudioTheme()->color(Theme::SplitterColor));
        else
    ...
    case CE_MenuItem:
        ...
        if (const QStyleOptionMenuItem *mbi = qstyleoption_cast<const QStyleOptionMenuItem *>(option)) {
            ...
            item.rect = mbi->rect;
            const QColor color = mediastudioTheme()->color(enabled
    ...
    case CE_MenuBarItem:
        ...
        if (const QStyleOptionMenuItem *mbi = qstyleoption_cast<const QStyleOptionMenuItem *>(option)) {
            ...
            if (mediastudioTheme()->widgetStyle() == Theme::StyleFlat)
                painter->fillRect(option->rect, mediastudioTheme()->color(Theme::MenuBarItemBackgroundColor));
            else
            ...
            pal.setBrush(QPalette::ButtonText, dis
                ? mediastudioTheme()->color(Theme::MenuBarItemTextColorDisabled)
                : mediastudioTheme()->color(Theme::MenuBarItemTextColorNormal));
            item.palette = pal;
    ...
    case CE_ComboBoxLabel:
        if (const QStyleOptionComboBox *cb = qstyleoption_cast<const QStyleOptionComboBox *>(option)) {
            if (panelWidget(widget)) {
                ...
                painter->setPen(mediastudioTheme()->color(Theme::ComboBoxTextColor));
                painter->drawText(editRect.adjusted(1, 0, -1, 0), Qt::AlignLeft | Qt::AlignVCenter, text);
    ...
    case CE_MenuBarEmptyArea: {
            if (mediastudioTheme()->widgetStyle() == Theme::StyleDefault) {
                ...
                painter->fillRect(option->rect, mediastudioTheme()->color(Theme::MenuBarEmptyAreaBackgroundColor));
            }
        }
        break;
    ...
    case CE_ToolBar:
        {
            ...
            if (horizontal)
            {
                ...
                if (mediastudioTheme()->widgetStyle() == Theme::StyleFlat)
                    painter->fillRect (rect, mediastudioTheme()->color(Theme::ToolBarBackgroundColor));
                else
